...
// @updateURL   https://github.com/TentacleTenticals/MAL-widget/raw/main/main.user.js
// @downloadURL https://github.com/TentacleTenticals/MAL-widget/raw/main/main.user.js
//
...
(async () => {
  ...
  const {build} = await import('https://cdn.jsdelivr.net/gh/TentacleTenticals/MAL-widget@1.0.52/main/build.js');
  const {connect} = await import('https://cdn.jsdelivr.net/gh/TentacleTenticals/MAL-widget@1.0.52/main/connect.js');
