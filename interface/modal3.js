export function tokenModal(El, Mal, o){
  El.Dialog({
    ...
    func: (d) => {
      const params = {
        'response_type': 'code',
        'client_id': o.secrets.client_id,
        'redirect_uri': o.secrets.redirect_uri,
        'code_challenge': Mal.cc(128)
      };
      const params2 = {
        grant_type: 'authorization_code',
        'client_id': o.secrets.client_id,
        'client_secret': o.secrets.client_secret,
        'redirect_uri': o.secrets.redirect_uri,
      ...
      El.Div({
        ...
        El.Button({
          ...
          func: (e) => el.code = e,
          onclick: () => {
            el.w = window.open(Mal.authUrl+'?'+new URLSearchParams(params));
          }
        });
